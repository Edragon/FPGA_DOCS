...
wire parity0  /* synthesis keep */;
wire parity1  /* synthesis keep */;
wire parity2  /* synthesis keep */;
wire parity3  /* synthesis keep */;
wire parity4  /* synthesis keep */;
wire parity5  /* synthesis keep */;
wire parity6  /* synthesis keep */;
wire parity7  /* synthesis keep */;
wire parity8  /* synthesis keep */;
wire parity9  /* synthesis keep */;
wire parity10 /* synthesis keep */;
integer i;
...
assign parity0  = last_data[ 0] ^ last_data[ 1] ^ last_data[ 2];
assign parity1  = last_data[ 3] ^ last_data[ 4] ^ last_data[ 5] ^ parity0;
assign parity2  = last_data[ 6] ^ last_data[ 7] ^ last_data[ 8] ^ parity1;
assign parity3  = last_data[ 9] ^ last_data[10] ^ last_data[11] ^ parity2;
assign parity4  = last_data[12] ^ last_data[13] ^ last_data[14] ^ parity3;
assign parity5  = last_data[15] ^ last_data[16] ^ last_data[17] ^ parity4;
assign parity6  = last_data[18] ^ last_data[19] ^ last_data[20] ^ parity5;
assign parity7  = last_data[21] ^ last_data[22] ^ last_data[23] ^ parity6;
assign parity8  = last_data[24] ^ last_data[25] ^ last_data[26] ^ parity7;
assign parity9  = last_data[27] ^ last_data[28] ^ last_data[29] ^ parity8;
assign parity10 = last_data[30] ^ last_data[31] ^ parity9;
